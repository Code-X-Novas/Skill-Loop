...
const Cart = () => {
    ...
    const handleCartBuyNow = async () => {
        ...
        if (
            ...
            toast.error("Required user information is missing. Please go to settings and update it first");
        ...
        try {
            ...
            handler: async function (response) {
                ...
                // ➜ Create transaction for this course
                ...
                // Update user document: clear cart & add purchased courses
                await updateDoc(userRef, {
                yourCourses: arrayUnion(...purchasedCourses),
                cart: [],
                });
