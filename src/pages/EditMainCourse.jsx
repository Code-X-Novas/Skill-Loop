      ...
      <div className="ml-64 flex-1 p-10 bg-white overflow-y-auto">
        ...
        <form onSubmit={handleUpdate} className="space-y-6 max-w-4xl mx-auto">
          ...
          <TextAreaField
            ...
            onChange={(e) =>
              setCourse({ ...course, onelineDescription: e.target.value })
            }
          />
          <UploadBox
            label="Thumbnail"
          ...
          <InputField
            ...
            onChange={(e) =>
              setCourse({
                ...course,
                seo: { ...course.seo, title: e.target.value },
              })
            }
          />
          <TextAreaField
            ...
            onChange={(e) =>
              setCourse({
                ...course,
                seo: { ...course.seo, metaDescription: e.target.value },
              })
            }
          />
          <InputField
            ...
            onChange={(e) =>
              setCourse({
                ...course,
                seo: { ...course.seo, slug: e.target.value },
              })
            }
          />
          <UploadBox
            ...
            onUpload={(url) =>
              setCourse({
                ...course,
                seo: { ...course.seo, socialPreview: url },
              })
            }
          />
          <div className="flex justify-between pt-4">
            ...
            <NavLink
              ...
              className="px-6 py-2 border cursor-pointer border-gray-400 bg-green-200 hover:bg-green-300 rounded flex items-center gap-2"
            >
              ➕ Add Subcategory
            </NavLink>
          </div>
...
//             <button
//               type="submit"
//               className="px-6 py-2 border cursor-pointer border-gray-400 bg-gray-100 hover:bg-gray-200 rounded"
//             >
//               Save Changes
//             </button>
//             <NavLink
