...
const Contact = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center px-4 py-5">
            <div className="max-w-3xl w-full rounded-xl px-8 py-5">
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="bg-gradient-to-r from-[#F4B860] to-[#D35244] text-white px-8 py-3 rounded-md font-medium text-sm hover:opacity-90 transition-all"
                    >
                        Send Message
                    </button>
                </form>
