    ...
    return (
        <div className="flex items-center justify-center min-h-screen p-4 sm:p-6 md:p-8 scrollbar-hide">
            <div className="w-full max-w-sm sm:max-w-md relative">
                ...
                <div className="p-[1px] rounded-2xl sm:rounded-3xl border border-orange-400/50">
                    <div className="bg-white/50 rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 relative overflow-hidden">
                        {/* Header */}
                        ...
                        <div className="space-y-4 sm:space-y-6 relative z-10">
                            {/* Email */}
                            <div className="bg-[#dcd6d4] p-3 rounded-lg sm:rounded-xl">
                                <label
                                    htmlFor="email"
