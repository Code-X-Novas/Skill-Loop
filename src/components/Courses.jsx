    ...
    return (
        <>
            ...
            >
                ...
                >
                    SkillLoop offers carefully designed certification programs,
                            ...
                            return (
                                ...
                                >
                                    <CourseCard
                                        ...
                                        id={course.id}
                                        description={
                                            course.onelineDescription?.length >
                                            150
                                                ? course.onelineDescription.slice(
                                                        0,
                                                        120
                                                    ) + "..."
                            ...
                            {courses.map((_, idx) => (
                                <div
                                    ...
                                    className={`w-3 h-3 rounded-full cursor-pointer transition ${
                                        idx === activeIndex
                                            ? "bg-linear-to-r from-[#F4B860] to-[#D35244] w-7 !h-2.5 self-center"
                                            : "bg-gray-300"
                                    }`}
                                />
                            ))}
