export function InternshipSidebar({ filters, onChange }) {
  return (
    <div className="bg-[#F8EEDD] p-6 rounded-lg shadow-md w-full max-w-xs">
      <h2 className="text-lg font-semibold mb-4">Type of Internship</h2>
      ...
      <h2 className="text-lg font-semibold mt-6 mb-4">Stipend</h2>
