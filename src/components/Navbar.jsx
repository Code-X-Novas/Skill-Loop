            ...
            <nav className="py-4 px-8">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <ul className="hidden lg:flex space-x-8 items-center">
                        ...
                        <li>
                            <NavLink to="/" className={({ isActive }) => `text-sm ${isActive ? "font-black" : ""}`} onClick={() => setIsActive(true)}>
                                Home
                            </NavLink>
                        </li>
                        ...
                        <li>
                            <NavLink to="/internship" className={({ isActive }) => `text-sm ${isActive ? "font-black" : ""}`} onClick={() => setIsActive(true)}>
                                Internship
                            </NavLink>
                        </li>
                        ...
                        <li>
                            <NavLink to="/contact" className={({ isActive }) => `text-sm ${isActive ? "font-black" : ""}`} onClick={() => setIsActive(true)}>
                                Contact
                            </NavLink>
                        </li>
                    </ul>
