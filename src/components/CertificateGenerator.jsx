        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 backdrop-blur-sm">
            <div className="bg-white p-4 rounded-xl w-[95%] md:w-[85%] max-w-5xl relative overflow-y-auto max-h-[95vh] flex flex-col items-center">
                ...
                >
                    ...
                    <div className="absolute xl:top-[65.5%] top-[65%] left-[24.5%] transform -translate-x-1/2 text-center font-serif text-[2vw] xl:text-xl font-bold">
                        {user.name.split(" ")[0]}
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="absolute -left-[300px] top-[545px] text-[22px] font-bold font-serif text-center w-full">
                        {user.name.split(" ")[0]}
                    </div>
                </div>
