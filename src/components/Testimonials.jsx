                    ...
                    <div className="bg-white">
                        <div className="bg-[#F9F6F0] p-6 rounded-tl-[150px] flex md:flex-row flex-col items-center justify-around md:px-24 px-4 md:py-12 py-2 md:gap-8 gap-4">
                            <div className="relative min-w-[150px] min-h-[150px] flex items-center justify-center">
                                <div className="bg-[#E28050]/50 rounded-md p-1 -mb-3 z-0 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 sm:w-[75px] sm:h-[190px] lg:h-[220px] w-[50px] h-[140px]"></div>
                                <img
                                    src={active.image}
                                    alt={active.name}
                                    className="rounded-lg relative z-10 sm:w-[150px] sm:h-[150px] lg:h-[180px] w-[100px] h-[100px] object-cover "
                                />
                            </div>
                                    ...
                                    return (
                                        <img
                                            ...
                                            className={`rounded-full cursor-pointer transition-all duration-500 ease-in-out absolute ${
                                                isActive
                                                    ? "sm:h-16 sm:w-16 h-12 w-12 opacity-100"
                                                    : "sm:h-8 sm:w-8 h-6 w-6 opacity-40"
                                            }`}
                                            style={{
