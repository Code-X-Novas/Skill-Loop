...
const Testimonials = () => {
  ...
  return (
    <div className="p-16">
        <h1 className="text-5xl font-bold text-gray-900 mb-8">Testimonials</h1>
        <div className="justify-center relative flex flex-col items-center gap-8">
            
            <div className="bg-linear-to-b from-[#F9A825] to-[#F4B860] text-white p-4 rounded-full shadow-md w-24 h-24">
                <img src='/quote.svg' alt="Quote Icon" className="w-full h-full" />
            </div>

            <div className="rounded-t-xl shadow-2xl bg-[#F9F6F0] w-[80vw] flex flex-col">
                <div className="relative flex flex-col items-center text-center font-semibold bg-white p-10 rounded-br-full text-3xl">
                    <p>Millions search for answers every month…</p>
                    <p>But true growth comes from structured learning</p>
                    <span className="absolute top-0 right-0 transform translate-x-1/2  h-24 w-24 bg-[#F4B860] rounded-full shadow-[#FF727242] shadow-lg"></span>
                </div>

                <div className="bg-white">
                    <div className="bg-[#F9F6F0] p-6 rounded-tl-[150px] flex items-center justify-around px-24 py-12">
                        ...
                        <div className="text-gray-600 text-sm mt-4 sm:mt-0 text-left max-w-xl">
                            <p>{active.text}</p>
                        </div>
                    </div>   
                </div>
                ...
                <div className="relative">
                    <span className="absolute bottom-0 left-0 transform -translate-x-1/2 translate-y-1/2 h-48 w-48 rounded-full bg-[#E28050] z-5 blur-sm opacity-50 "></span>
                    <div className="relative flex justify-center items-center gap-6 py-6 overflow-clip">
                    <span className="absolute bottom-0 left-0 transform -translate-x-1/2 translate-y-1/2 h-48 w-48 border-[1rem] rounded-full border-[#E28050] bg-[#F9F6F0] z-10"></span>
                    ...
                    <div className="flex justify-center items-center gap-2 transition-all duration-500 ease-in-out relative">
                            ...
                            return (
                                <img
                                    ...
                                    className={`rounded-full cursor-pointer transition-all duration-500 ease-in-out absolute ${
                                        isActive ? "h-24 w-24 opacity-100" : "h-12 w-12 opacity-40"
                                    }`}
                                    style={{
                        ...
                        <div className="w-48 h-24 opacity-0"></div>
                    </div>
