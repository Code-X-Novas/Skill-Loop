...
export function InternshipHeader() {
  return (
    <div className="bg-[#F8EEDD] py-10 px-4 sm:px-8 lg:px-16">
      ...
      <p className="text-gray-700 mb-6">Search your career opportunity through 12,800 internships</p>
      <div className="flex flex-col sm:flex-row gap-4 bg-white px-6 py-4 sm:rounded-full rounded-xl shadow-md justify-between items-center">
        ...
        <button className="bg-gradient-to-r from-[#F4B860] to-[#D35244] text-white rounded-full px-6 py-2">Find Internships</button>
      </div>
    </div>
  );
}