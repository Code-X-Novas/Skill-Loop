        ...
        <>
            <Routes>
                ...
                >
                    ...
                    <Route
                        path="/courses/:courseId/subcategory/:subCategoryId/edit"
                        element={<EditSubCategory />}
                    />
                    <Route
                        path="/courses/:courseId/edit"
                        element={<EditMainCourse />}
                    />
                    <Route
                        path="/courses/:courseId/subcategory/add"
                    ...
                    />
                    <Route
                        path="/internships/edit/:internshipId"
                        element={<EditInternshipOffer />}
                    />
                    <Route
                        path="/postings/new"
